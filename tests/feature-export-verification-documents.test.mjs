...
for (const asset of ['visual-system.css','visual-verify.css','visual-documents.css','visual-overlays.css','visual-responsive.css','visual-refinement.css','js/marking-policy-ui.js','js/copy-evidence-edit-ui.js','js/ui-refinement.js','js/document-lifecycle.js','js/document-management-ui.js','js/sync-delete-queue.js']) {
...
assert.match(authEntry, /import\('\.\/document-management-ui\.js'\)/);
