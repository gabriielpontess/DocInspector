...
assert.match(serviceWorker, /\.\/js\/document-management-ui\.js/);
assert.match(serviceWorker, /const VERSION = '0\.9\.37'/, 'gerenciamento de documentos offline deve avançar a identidade técnica do cache');
