...
const APP_SHELL = [
  './', './index.html', './styles.css', './visual-system.css', './visual-verify.css', './visual-documents.css', './visual-overlays.css', './visual-responsive.css',
  ...
  './js/marking-policy-ui.js', './js/copy-evidence-edit-ui.js', './js/pwa.js', './js/report.js', './js/sync.js', './js/ui.js', './js/xlsx.js', './js/vision.js', './js/word.js'
];
